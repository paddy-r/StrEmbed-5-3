...
# For STEP import
from step_parse_5_3 import StepParse
...
class MainWindow(wx.Frame):
    ...
    def __init__(self):
        ...
        wx.Frame.__init__(self, parent = None, title = "StrEmbed-5-3")
...
#        self.latt_tb.Realize()
    ...
    def OnAbout(self, event):
        ...
        # Show program info
        abt_text = """StrEmbed-5-3: A user interface for manipulation of design configurations\n
        ...
        abt = wx.MessageDialog(self, abt_text, 'About StrEmbed-5-3', wx.OK)
